...
videoFiles = [f for f in listdir(sys.argv[1]) if isfile(join(sys.argv[1], f)) and ".mp4" in f]

for video in videoFiles:
    input_path = join((sys.argv[1]).replace("\\", "/"), video)
    ...
    print("[INFO] opening video file: ", video)
