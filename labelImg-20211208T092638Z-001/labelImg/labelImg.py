...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultSaveDir=None):
        ...
        self.actions.beginner = (
            open, opendir, openNextImg, openPrevImg, verify, save, save_format, None, create, copy, delete, None,
    ...
    def loadYOLOTXTByFilename(self, txtPath):
        ...
        print(shapes)
        if len(self.labelHist) == 0:
            print("filling label hist")
            dir_path = os.path.dirname(os.path.realpath(txtPath))
            classListPath = os.path.join(dir_path, "classes.txt")
            self.loadPredefinedClasses(classListPath)
        self.loadLabels(shapes)
